...
/**
 * \file   ltiUnsharpMaskingGaussianGenetics.h
 *         Defines the abstract parent class of the genetics for sharpening
 *         algorithm.
 * \author Miguel Angel Aguilar Ulloa
 * \date   19.11.07
 *
 * $Id: ltiUnsharpMaskingGaussianGenetics.h,v 1.1 2008-06-02 02:45:50 alvarado Exp $
 */

#ifndef _LTI_UNSHARP_MASKING_GAUSSIAN_GENETICS_H_
#define _LTI_UNSHARP_MASKING_GAUSSIAN_GENETICS_H_
...
namespace lti {
  ...
  /**
   * Evaluate unsharp masking with gaussian kernel.
   */
  class unsharpMaskingGaussianGenetics : public sharpeningGenetics {
  public:
    /**
     ...
     * Destructor
     */
    virtual ~unsharpMaskingGaussianGenetics();
     ...
     * Clone method.
     */
    virtual unsharpMaskingGaussianGenetics* clone() const;

    /**
     * New instance method.
     */
    virtual unsharpMaskingGaussianGenetics* newInstance() const;

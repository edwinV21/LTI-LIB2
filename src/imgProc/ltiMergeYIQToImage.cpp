 ...
 * \date   19.04.1999
 *
 * $Id: ltiMergeYIQToImage.cpp,v 1.2 2007-04-06 01:16:32 alvarado Exp $
 */
...
namespace lti {
  ...
  _LTI_REGISTER_IN_FACTORY_AS(YIQ,mergeImage,mergeYIQToImage)

  // merge YIQ channels to image

  // return the name of this type
  // returns the name of this class
  const std::string& mergeYIQToImage::name() const {
    _LTI_RETURN_CLASS_NAME
  }

  // returns a pointer to a clone of the functor.
  mergeYIQToImage* mergeYIQToImage::clone() const {
    return (new mergeYIQToImage(*this));
  }

  // returns a pointer to a clone of the functor.
  mergeYIQToImage* mergeYIQToImage::newInstance() const {
    return (new mergeYIQToImage);
  }
  ...
  bool mergeYIQToImage::apply(const matrix<ubyte>& c1,

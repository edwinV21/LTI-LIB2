...
/**
 * \file   ltiSplitImageToYCbCr.cpp
 *         Split color image to YCbCr
 * \author Pablo Alvarado
 * \date   04.01.2007
 *
 * $Id: ltiSplitImageToYCbCr.cpp,v 1.2 2007-04-06 01:16:32 alvarado Exp $
 */
...
namespace lti {
  ...
  _LTI_REGISTER_IN_FACTORY_AS(YCbCr,splitImage,splitImageToYCbCr)
  ...
  // default constructor
  splitImageToYCbCr::splitImageToYCbCr()
    : splitImage() {
  }

  // copy constructor
  splitImageToYCbCr::splitImageToYCbCr(const splitImageToYCbCr& other) : splitImage() {
    copy(other);
  }
  ...
  const std::string& splitImageToYCbCr::name() const {
    _LTI_RETURN_CLASS_NAME
  }

  // copy member
  splitImageToYCbCr& splitImageToYCbCr::copy(const splitImageToYCbCr& other) {
  ...
  // clone member
  splitImageToYCbCr* splitImageToYCbCr::clone() const {
    return (new splitImageToYCbCr(*this));
  }

  // clone member
  splitImageToYCbCr* splitImageToYCbCr::newInstance() const {
    return (new splitImageToYCbCr);
  }
  ...
  bool splitImageToYCbCr::apply(const matrix<rgbaPixel>& img,
                                matrix<float>& c1,
                                matrix<float>& c2,

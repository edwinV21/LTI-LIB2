 ...
 * \date   21.11.2003
 *
 * $Id: ltiInterpolationType.h,v 1.1 2005-01-12 13:27:26 doerfler Exp $
 */

#ifndef _LTI_INTERPOLATION_TYPE_H_
#define _LTI_INTERPOLATION_TYPE_H_

 ...
 * \date   06.12.2000
 * 
 * $Id: ltiPolygonPoints.h,v 1.5 2012-09-16 05:22:59 alvarado Exp $
 */

#ifndef _LTI_POLYGON_POINTS_H
#define _LTI_POLYGON_POINTS_H
...
namespace lti {
   ...
   */
  template<class T>
  class polygonPoints : public pointList<T> {
  ...
  public:
     ...
     */
    inline polygonPoints<T>& operator=(const polygonPoints<T>& other);
  ...
  protected:
     ...
     * 1992.  pp. 563ff
     *
     * @param vct set of vertices of the polygon
     * @param idx1 initial index
     * @param idx2 final index
     * @param maxDistance maximum allowed distance
     * @param flags flags for the points.
     */
    void fitAndSplit(const vector< ipoint >& vct,
                     const int idx1,
                     const int idx2,
...
#include "ltiPolygonPoints_inline.h"

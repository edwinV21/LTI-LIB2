...
/**
 * \file   ltiIoHandler.h
 *         Contains the class lti::ioHandler, which is the base for all
 *         serialization concepts in the LTI-Lib
 * \author Pablo Alvarado
 * \date   07.12.2000
 *
 * $Id: ltiIoHandler.h,v 1.13 2009-12-04 04:10:23 alvarado Exp $
 */
...
#include "ltiIoHandler_template.h"

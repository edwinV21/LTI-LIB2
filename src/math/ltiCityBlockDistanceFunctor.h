...
/**
 * \file   ltiCityBlockDistanceFunctor.h
 *         This file contains the class cityblockdistanceFunctor,
 *         which calculates the L1 distance between two vectors or
 *         matrices.
 * \author Jochen Wickel
 * \date   28.06.2000
 *
 * $Id: ltiCityBlockDistanceFunctor.h,v 1.1 2005-03-29 13:26:45 doerfler Exp $
 */

#ifndef _LTI_CITY_BLOCK_DISTANCE_FUNCTOR_H_
#define _LTI_CITY_BLOCK_DISTANCE_FUNCTOR_H_
...
namespace lti {
   ...
   */
  template <typename T>
  class cityBlockDistanceFunctor: public distanceFunctor<T> {
  public:

    /**
     * The cityBlockDistance uses the same parameters as its base
     ...
     */
    cityBlockDistanceFunctor(const cityBlockDistanceFunctor<T>& other);

    /**
     * destructor
     */
    virtual ~cityBlockDistanceFunctor();
    ...
    copy(const cityBlockDistanceFunctor<T>& other);
     ...
     */
    virtual cityBlockDistanceFunctor<T>* clone() const;

    /**
     * returns a pointer to a new instance of this functor.
     */
    virtual cityBlockDistanceFunctor<T>* newInstance() const;

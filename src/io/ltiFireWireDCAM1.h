 ...
 * \date   21.10.2004
 * $Id: ltiFireWireDCAM1.h,v 1.1 2012-01-05 18:32:32 alvarado Exp $
 */

#ifndef _LTI_FIRE_WIRE_DCAM_1_H_
#define _LTI_FIRE_WIRE_DCAM_1_H_
...
namespace lti {
  ...
  public:
    ...
    /**
     * Initializes the IEEE 1394 Bus and checks for available cameras.
     *
    ...
    /**
     * Returns true if the IEEE 1394 bus has has already being initialized
     */
  ...
  protected:
     ...
     * only
     */
    void yuv411toChannel8(channel8& srcdest) const;
     ...
     * only
     */
    void yuv422toChannel8(channel8& srcdest) const;
    ...
    public:
       ...
       *          be found.
       */
      bool query(const u_int64_t& id, std::string& name) const;
     ...
     * called, in which case som memory has been reserved, etc. (in
